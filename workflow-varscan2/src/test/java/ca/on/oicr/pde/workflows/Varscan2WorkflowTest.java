 ...
 * @author prath
 */
public class Varscan2WorkflowTest {

    public Varscan2WorkflowTest() {
    }
    ...
    public void validateRegressionTestDefinition() throws IllegalAccessException, InstantiationException, IOException, Exception {
        ...
        for (TestDefinition.Test t : td.getTests()) {
            DryRun d = new DryRun(System.getProperty("bundleDirectory"), t.getParameters(), Varscan2Workflow.class);
